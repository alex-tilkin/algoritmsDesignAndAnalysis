package algorithmsDesignAndAlnalysis;

// Thanks to Jason Goh for the code (http://jasongoh1987.blogspot.com/2013/12/simplex-implementation-in-java-with.html)
public class Simplex {
	...
	public void show() {
		...
		for (int i = 0; i < numberOfConstraints; i++)
			if (basis[i] < numberOfOriginalVariables)
				System.out.println(
						"x_" + basis[i] + " = " + tableaux[i][numberOfConstraints + numberOfOriginalVariables]);
		System.out.println();
	}
